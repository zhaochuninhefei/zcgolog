...
// var initZcgoLoggerForDefaultOnce sync.Once

// // 初始化默认zcgoLogger
// //  只尝试执行一次
// func initZcgoLoggerForDefault() {
// 	if zcgoLogger != nil {
// 		return
// 	}
// 	// 初始化zcgoLogger
